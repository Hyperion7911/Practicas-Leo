...
public class CuentaBancaria {
    ...
    public CuentaBancaria(String titular, double saldoInicial) {
        ...
        this.historial = new ArrayList<>(); // Inicializa el historial con el saldo inicial
    ...
    public void retirar(double monto) {
        if (monto <= saldo) { // Verifica si hay saldo suficiente para el retiro
            saldo -= monto; // Reduce el saldo con el monto retirado
            // Registra la transacción en el historial y muestra un mensaje
